...
###### Wallen2
PDlist2 = readRDS("~/manuscript/realdata/PD/Wallen2.rds")
otutable=PDlist2$otu
meta = PDlist2$meta
...
##### Wallen1
PDlist = readRDS("~/manuscript/realdata/PD/Wallen1.rds")
otutable1=PDlist$otu
meta1 = PDlist$meta
...
for(i in 1:num){
  ...
  rej=PODA( Y = Y, u = u, confoun = NULL,rep_time=500,tau = 1,fdrnomial=0.05 ,lib_cut=0,
            pre_cut=0,nCore=9)
  rej=rej$rej
  if(length(rej)!=0){
