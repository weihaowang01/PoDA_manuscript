...
#################################################################
#### generate sampling fraction and covariate coefficients  #####
#################################################################
# Please comment or retain the following code modules based on the corresponding simulation setting,
# with the default set to setting A8.

# ######################## setting A8 ##########################
# # To generate data under setting A8, please comment out this section of the code.
...
# ######################## setting A9 ##########################
# # To generate data under setting A9, please comment out this section of the code.
# smd = data.frame(sample = paste0("sample", seq_len(n)),
...
#################################################################
### add effect sizes of covariates to the absolute abundances ###
#################################################################
...
true_abundance = exp(log_abn_data)    
