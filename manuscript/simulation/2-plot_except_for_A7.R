...
# Read the corresponding results. Main results can be found at ~/manuscript/simulation/Results.
A <- readRDS("~/manuscript/simulation/Results/main/A1binomialSE.rds")
simlist <- t(A[1:3,])
colind <- c(1,2,5,4,3)
...
ggsave("~/manuscript/simulation/Plots/main/A1binomial.png", p.comb, width = 4*3.5, height =2.5*3.5, limitsize = FALSE ,bg = "white")
