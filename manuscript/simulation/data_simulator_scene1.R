...
######## setting A1-A3&A5-A7&A11-A12 #########
set.seed(q)
u <- rbinom(n, 1, 0.5) #A1-A3&A5&A11-A12
# u <- rbinom(n, 1, 0.8) #A6
# u = runif(n,-1,1) #A7
